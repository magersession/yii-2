...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 26, 2023 at 03:13 AM
...
INSERT INTO `obat` (`id_obat`, `nama_obat`, `satuan`, `harga`, `jumlah`, `exp_date`) VALUES
(1, 'Panadol', '1', 500, 10, '2025-09-20'),
(2, 'Promag', '0', 1000, 4, '2023-09-24');
...
(1, 'Dudung', 0, '2000-09-01', 'Bandung', '0800000000'),
(7, 'Bobo', 0, '2000-01-01', 'Bandung', '08123456789'),
(8, 'Dudung', 0, '2005-01-01', 'Bandung', '08123456789');
...
INSERT INTO `pegawai` (`id_pegawai`, `nama`, `alamat`, `no_telepon`) VALUES
(1, 'Dadang', 'Bandung', '0811111111'),
(2, 'Deden', 'Bandung', '0822222222'),
(3, 'Dede', 'Bandung', '0833333333'),
(4, 'Test', 'Bandung', '0812345689');
...
INSERT INTO `transaksi` (`id_transaksi`, `id_pasien`, `id_pegawai`, `keluhan`, `diagnosa`, `id_tindakan`, `qty`, `resep`, `id_obat`, `total`, `bayar`, `status`) VALUES
(8, 7, 1, 'Pusing', 'Tekanan darah rendah', 1, 5, '1x1', 1, 0, 0, 1),
(10, 1, NULL, 'Pusing', 'Tekanan darah rendah', 1, 5, '1x1', 1, 2500, 0, 1),
(11, 8, 1, 'Pusing', 'Tekanan darah rendah', 1, 6, '1x1', 2, 6000, 0, 1);
...
INSERT INTO `user` (`id_user`, `id_pegawai`, `level`, `username`, `password`, `enkrip`, `email`) VALUES
(1, 1, 1, 'admin', 'f789ec748fbe32ae8d66761d31cfc8e8', '650b2044f02ce1.58996533', 'admin@gmail.com'),
(3, 1, 2, 'dokter', '48fd81a3808942717e8cb9b906af19e2', '650f9b908c5113.28114991', 'dokter@gmail.com'),
(4, 2, 0, 'dede_yusuf', '4d380afacb4fd41be8f841f3763fc6b9', '650ff7be2019a8.35308759', 'dedeng@gmail.com');
